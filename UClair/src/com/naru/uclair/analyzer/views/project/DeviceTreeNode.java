...
public class DeviceTreeNode implements MutableTreeNode {

	public static final String DEFAULT_NAME = "I/O 디바이스";
	...
	public DeviceTreeNode(DeviceConfiguration userObject) {
		super();
		parent = null;
