...
public class ScriptTreeNode implements MutableTreeNode {

	public static final String DEFAULT_NAME = "스크립트";

	private MutableTreeNode parent;
	private Vector children;

	// private ScriptEnvironment userObject;

	public ScriptTreeNode() {
		// this(null);
	}

	// public ScriptTreeNode (ScriptEnvironment userObject) {
	// super();
	// parent = null;
	...
	public void setUserObject(final Object object) {
		// if (object instanceof ScriptEnvironment) {
		// userObject = (ScriptEnvironment) object;
		// }
	}
