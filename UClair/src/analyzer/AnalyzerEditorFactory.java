...
import analyzer.ui.script.ScriptSyntaxAnalyzeResultView;
...
public class AnalyzerEditorFactory {
	...
	public static final String NETWORK_INFO_EDITOR_KEY = AnalyzerConstants
			.getString("AnalyzerEditorFactory.network.key"); //$NON-NLS-1$
	public static final String ALARM_INFO_EDITOR_KEY = AnalyzerConstants.getString("AnalyzerEditorFactory.alarm.key"); //$NON-NLS-1$
	public static final String TAG_INFO_EDITOR_KEY = AnalyzerConstants
			.getString("AnalyzerEditorFactory.tagdictionary.key"); //$NON-NLS-1$
	public static final String DEVICE_INFO_EDITOR_KEY = AnalyzerConstants.getString("AnalyzerEditorFactory.device.key"); //$NON-NLS-1$
	public static final String DATA_COLLECT_EDITOR_KEY = AnalyzerConstants
			.getString("AnalyzerEditorFactory.datacollection.key"); //$NON-NLS-1$
